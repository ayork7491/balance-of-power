...
import { Shield, Users, Play, Loader2, AlertTriangle, RefreshCw, Settings, Bell, Check, X, Trash2, FlaskConical } from 'lucide-react';
...
export default function CampaignLobby() {
  ...
  return (
    <AppShell showBack title={campaign.name}>
